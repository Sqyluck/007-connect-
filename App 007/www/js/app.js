...
app.controller('main', ['$scope', '$http', '$rootScope', '$timeout', '$location', '$routeParams', ($scope, $http, $rootScope, $timeout, $location, $routeParams) => {
  var joinGameRequest = () => {
    return new Promise((resolve, reject) => {
      var url = 'http://' + $rootScope.ipAddress + '/joinGame?idPlayer=' + $rootScope.idPlayer
      console.log(url)
      $http({
        method: 'GET',
        url: url
  ...
  var startGameRequest = () => {
    return new Promise((resolve, reject) => {
      var url = 'http://' + $rootScope.ipAddress + '/gameStarted'
      $http({
        method: 'GET',
        url: url
      }).then((response) => {
  ...
  $scope.joinGame = () => {
    ...
    .then((response) => {
      ...
      console.log('id : ' + $rootScope.idPlayer + ', life : ' + $rootScope.life + ', bullet : ' + $rootScope.bullet)
...
app.controller('game', ['$scope', '$rootScope', '$http', '$timeout', '$location', ($scope, $rootScope, $http, $timeout, $location) => {
  ...
  var actionReqest = (action) => {
    return new Promise((resolve, reject) => {
      var url = 'http://' + $rootScope.ipAddress + '/action?idPlayer=' + $rootScope.idPlayer + '&action=' + action
      $http({
        method: 'GET',
        url: url
      }).then((response) => {
  ...
  var getResultRequest = () => {
    return new Promise((resolve, reject) => {
      var url = 'http://' + $rootScope.ipAddress + '/getResult?idPlayer=' + $rootScope.idPlayer
      $http({
        method: 'GET',
        url: url
      }).then((response) => {
...
app.controller('result', ['$scope', '$rootScope', '$location', '$http', ($scope, $rootScope, $location, $http) => {
  ...
  var quitRequest = () => {
    return new Promise((resolve, reject) => {
      var url = 'http://' + $rootScope.ipAddress + '/quit?idPlayer=' + $rootScope.idPlayer
      $http({
        method: 'GET',
        url: url
      }).then((response) => {
